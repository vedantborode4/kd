        ...
        <div className="cards grid grid-cols-2 justify-center mt-5 gap-4">
          {cardData.map((card, index) => (
            <div key={index} className="flex justify-center">
              <a href={card.link} className="no-underline">
...
const cardData = [
    { title: 'E-Mandate', imgSrc: 'https://erpstudentmobileapp.s3.ap-south-1.amazonaws.com/Profileicon/emandate.svg', link: '/Academics' },
    { title: 'Fees Receipts', imgSrc: 'https://erpstudentmobileapp.s3.ap-south-1.amazonaws.com/Profileicon/fee-receipt.svg', link: '/FeeReceipt' },
    { title: 'Pay Fees', imgSrc: 'https://erpstudentmobileapp.s3.ap-south-1.amazonaws.com/Profileicon/pay-fees.svg', link: '/Admission' },
    { title: 'Social Welfare Details', imgSrc: 'https://erpstudentmobileapp.s3.ap-south-1.amazonaws.com/Profileicon/emandate.svg', link: '/ASPORTAL' },
];
